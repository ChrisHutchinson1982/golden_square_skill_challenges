require '05_test_drive_a_class/diary_entry_05'

RSpec.describe DiaryEntry05 do
  
  it "adds and returns a string of the title" do
    diary_entry = DiaryEntry05.new("Today", "I am feeling great!")
  ...
  describe "@count_words" do
    ...
    it "returns 0 when of contents when empty" do
      diary_entry = DiaryEntry05.new("Today", "")
  ...
  describe "@reading_chunk" do
    it "add and returns reading_chunk from contents that user can read in a minute" do
      diary_entry = DiaryEntry05.new("Today", "I am feeling great but think sounds tricky!")
